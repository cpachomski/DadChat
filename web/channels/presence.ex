defmodule Dadchat.Presence do
  ...
  Presences can be tracked in your channel after joining:
      ...
      defmodule Dadchat.MyChannel do
        use Dadchat.Web, :channel
        alias Dadchat.Presence
  ...
  """
  use Phoenix.Presence, otp_app: :dadchat,
                        pubsub_server: Dadchat.PubSub
end
